...
config.bot.mongourl = process.env.mongo_url
config.bot.servers.token = process.env.server_token
config.website.secret = process.env.bot_secret
...
client.on('ready',async () => {
    ...
    client.user.setPresence({ activity: { type: 'WATCHING', name: 'RET Bot List | '+bots.length+' bots' }, status: "dnd" });
});
/*=======================================================================================*/
